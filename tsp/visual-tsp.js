...
var g_instructions = "Инструкции:\n\nОдиночный клик добавляет вершину.\nДвойной клик удаляет вершину.\nНа вершину можно нажать и перетащить.\nМаксимальное число вершин 9.";
...
function callReactRefPaths() {
  ...
  var lengths = [calculateRouteLength(g_shortestRoute)];
  var checkeds = [state.checkboxes[0], state.checkboxes[1]];
  var pids = [0, 1];
  var strings = ["Показывать кратчайший путь"];
